...
# Population Data Table Creation
def pop_data_creation(tableName):
...
# Country Data Table Creation
def country_data_creation(tableName):
    # Establish a connection to the AWS resource dynamodb
    # Replace xxxx with your name
    session = boto3.Session(region_name='ca-central-1')
    dynamodb = session.resource('dynamodb', region_name='ca-central-1')
...
#Economics Data Table Creation
def economic_creation(tableName):
    # Establish a connection to the AWS resource dynamodb
    # Replace xxxx with your name
    session = boto3.Session(region_name='ca-central-1')
    dynamodb = session.resource('dynamodb', region_name='ca-central-1')
